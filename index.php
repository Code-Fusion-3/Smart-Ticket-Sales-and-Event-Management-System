...
?>
        ...
        <div class="bg-indigo-600 text-white py-16">
            <div class="container mx-auto px-4">
                <div class="text-center mb-12">
                    <h2 class="text-xl font-bold mb-4">Why Choose Our Platform?</h2>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div class="text-center">
                        <div
                            class="bg-white bg-opacity-10 rounded-full w-20 h-20 flex items-center justify-center mx-auto mb-6">
                            <i class="fas fa-search text-3xl text-green-300"></i>
                        </div>
                        <h3 class="text-xl font-semibold mb-3">Discover Events</h3>
                        <p class="text-indigo-200">Find amazing events happening near you, from concerts to workshops
                        </p>
                    </div>
            ...
            ?>
                    <div class="bg-white bg-opacity-10 rounded-lg p-6 inline-block">
                        <span
                            class="text-2xl font-bold text-green-300"><?php echo number_format($quickStats['events'] ?? 0); ?></span>
                        <span class="text-indigo-200 mx-4">events available</span>
                        <span
                            class="text-2xl font-bold text-blue-300"><?php echo number_format($quickStats['customers'] ?? 0); ?>+</span>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6">
            ...
            <!-- Revenue & Growth -->
            <div class="bg-white bg-opacity-10 rounded-lg p-6 backdrop-blur-sm hidden">
                <h3 class="text-lg font-semibold mb-4 flex items-center">
    ...
    <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                ...
                <p class="text-gray-600">"As an event planner, this system has revolutionized how I manage ticket sales.
                    The analytics and reporting features are fantastic!"</p>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                ...
                <p class="text-gray-600">"The mobile tickets with QR codes make entry so convenient. No more worrying
                    about losing paper tickets!"</p>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8">
            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                ...
                <p class="text-gray-600">"Customer support is outstanding! They helped me resolve an issue within
                    minutes. Highly recommend this platform."</p>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                ...
                <p class="text-gray-600">"The variety of events available is impressive. I've discovered so many great
                    local events through this platform!"</p>
            </div>
        </div>
    </div>
</div>
