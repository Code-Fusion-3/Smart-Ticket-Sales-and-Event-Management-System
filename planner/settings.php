                        ...
                        <div class="space-y-4">
                            <div class="flex items-center">
                                ...
                                <label for="email_notifications" class="ml-2 block text-gray-700">
                                    Email Notifications
                                    <p class="text-sm text-gray-500">Receive important updates about your account via
                                        email</p>
                                </label>
                            </div>
                            ...
                            <div class="flex items-center">
                                <input type="checkbox" id="payment_notifications" name="payment_notifications"
                                    class="h-4 w-4 text-indigo-600" checked>
                                <label for="payment_notifications" class="ml-2 block text-gray-700">
                                    Payment Notifications
                                    <p class="text-sm text-gray-500">Receive notifications about payments and
                                        withdrawals</p>
                                </label>
                            </div>
                            ...
                            <div class="flex items-center">
                                ...
                                <label for="marketing_emails" class="ml-2 block text-gray-700">
                                    Marketing Emails
                                    <p class="text-sm text-gray-500">Receive promotional emails about new features and
                                        offers</p>
                                </label>
                            </div>
                        </div>
            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden">
                ...
                <div class="p-6">
                    <div class="bg-red-50 border border-red-200 text-red-800 px-4 py-3 rounded mb-6">
                        ...
                        <p class="mt-2">If you wish to temporarily stop using the platform, consider not deactivating
                            your account.</p>
                    </div>
                    ...
                    <form method="POST" action=""
                        ...
                        <div class="space-y-4">
                            <div>
                                <label for="deactivation_password" class="block text-gray-700 font-bold mb-2">Enter Your
                                    Password *</label>
                            ...
                            <div>
                                <label for="deactivation_confirmation" class="block text-gray-700 font-bold mb-2">Type
                                    DEACTIVATE to confirm *</label>
                ...
                <div class="p-6">
                    <div class="space-y-4">
                        <div>
                            ...
                            <a href="mailto:support@<?php echo $_SERVER['HTTP_HOST']; ?>"
