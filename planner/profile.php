                    ...
                    <form method="POST" action="" enctype="multipart/form-data">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            ...
                            <div>
                                ...
                                <input type="text" id="role" value="<?php echo ucfirst(str_replace('_', ' ', $user['role'])); ?>" 
                            ...
                            <div class="flex items-center">
                                <div class="mr-4">
                                    <?php if (!empty($user['profile_image'])): ?>
                                        <img src="<?php echo SITE_URL . '/' . $user['profile_image']; ?>" alt="Profile" class="w-24 h-24 rounded-full object-cover">
                                    <?php else: ?>
            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden mb-6">
                ...
                <div class="p-6">
                    <div class="flex items-center justify-between mb-4 pb-4 border-b">
                        ...
                        <div class="text-xl font-bold text-indigo-600"><?php echo formatCurrency($user['balance']); ?></div>
                    </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex justify-between">
                            ...
                            <div class="font-medium"><?php echo formatCurrency($ticketStats['total_sales'] ?? 0); ?></div>
                        </div>
                    ...
                    <div class="mt-6">
                        <a href="finances/index.php" class="block w-full bg-indigo-600 hover:bg-indigo-700 text-white text-center font-bold py-2 px-4 rounded">
