...
<div class="container mx-auto px-4 py-6">
    <div class="flex justify-between items-center mb-6">
        ...
        <?php if ($eventId > 0): ?>
            <a href="event-details.php?id=<?php echo $eventId; ?>" class="bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-2 px-4 rounded">
        ...
        <form method="GET" action="" class="flex flex-wrap items-end gap-4">
            ...
            <?php else: ?>
                <div class="w-full md:w-auto flex-grow">
                    ...
                    <select id="event_id" name="event_id" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:border-indigo-500">
                        ...
                        <?php foreach ($tickets as $ticket): ?>
                            <tr>
                                ...
                                <td class="py-4 px-4 border-b border-gray-200 text-sm">
                                    <a href="?action=view&id=<?php echo $ticket['id']; ?><?php echo $eventId ? '&event_id=' . $eventId : ''; ?>" class="text-indigo-600 hover:text-indigo-900 mr-3">
...
<div class="container mx-auto px-4 py-6">
    <div class="flex justify-between items-center mb-6">
        <div>
            <a href="tickets.php<?php echo $eventId ? '?event_id=' . $eventId : ''; ?>" class="text-indigo-600 hover:text-indigo-800">
        ...
        <div class="flex space-x-2">
            ...
            <a href="print-ticket.php?id=<?php echo $ticketId; ?>" target="_blank" class="bg-gray-600 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <p class="text-base font-medium"><?php echo htmlspecialchars($ticket['event_title']); ?></p>
                            </div>
                            ...
                            <div>
                                ...
                                <p class="text-base font-medium"><?php echo formatTime($ticket['start_time']); ?> - <?php echo formatTime($ticket['end_time']); ?></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <p class="text-base font-medium"><?php echo htmlspecialchars($ticket['ticket_type'] ?? 'Standard'); ?></p>
                                <?php if (!empty($ticket['ticket_type_description'])): ?>
                                    <p class="text-sm text-gray-500 mt-1"><?php echo htmlspecialchars($ticket['ticket_type_description']); ?></p>
                                <?php endif; ?>
                            </div>
                            
                            <div>
                                <p class="text-sm text-gray-500">Purchase Price</p>
                                <p class="text-base font-medium"><?php echo formatCurrency($ticket['purchase_price']); ?></p>
                            </div>
                            ...
                            <div>
                                ...
                                <p class="text-base font-medium"><?php echo formatDate($ticket['created_at']); ?> at <?php echo formatTime($ticket['created_at']); ?></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <div class="bg-gray-50 p-4 rounded-lg">
                                ...
                                <p class="text-base font-medium"><?php echo htmlspecialchars($ticket['username']); ?></p>
                                
                                <p class="text-sm text-gray-500 mt-2">Email</p>
                                <p class="text-base font-medium"><?php echo htmlspecialchars($ticket['user_email']); ?></p>
                                
                                <?php if (!empty($ticket['user_phone'])): ?>
                                    <p class="text-sm text-gray-500 mt-2">Phone</p>
                                    <p class="text-base font-medium"><?php echo htmlspecialchars($ticket['user_phone']); ?></p>
                                <?php endif; ?>
                            </div>
                        </div>
                            ...
                            <div class="bg-gray-50 p-4 rounded-lg">
                                <?php if (!empty($ticket['recipient_name']) || !empty($ticket['recipient_email']) || !empty($ticket['recipient_phone'])): ?>
                                    <?php if (!empty($ticket['recipient_name'])): ?>
                                        <p class="text-sm text-gray-500">Name</p>
                                        <p class="text-base font-medium"><?php echo htmlspecialchars($ticket['recipient_name']); ?></p>
                                    <?php endif; ?>
                                    
                                    <?php if (!empty($ticket['recipient_email'])): ?>
                                        <p class="text-sm text-gray-500 mt-2">Email</p>
                                        <p class="text-base font-medium"><?php echo htmlspecialchars($ticket['recipient_email']); ?></p>
                                    <?php endif; ?>
                                    
                                    <?php if (!empty($ticket['recipient_phone'])): ?>
                                        <p class="text-sm text-gray-500 mt-2">Phone</p>
                                        <p class="text-base font-medium"><?php echo htmlspecialchars($ticket['recipient_phone']); ?></p>
                                    <?php endif; ?>
                                <?php else: ?>
        ...
        <div>
            <div class="bg-white rounded-lg shadow-md overflow-hidden mb-6">
                ...
                <div class="p-6 text-center">
                    <?php if (!empty($ticket['qr_code'])): ?>
                        <img src="<?php echo SITE_URL . '/' . $ticket['qr_code']; ?>" alt="Ticket QR Code" class="mx-auto max-w-full h-auto">
                    <?php else: ?>
            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden">
                ...
                <div class="p-6">
                    <div class="space-y-3">
                        <a href="print-ticket.php?id=<?php echo $ticketId; ?>" target="_blank" class="block w-full bg-white hover:bg-gray-50 text-gray-700 font-medium py-2 px-4 border border-gray-300 rounded-md text-center transition duration-150">
                            <i class="fas fa-print mr-2"></i> Print Ticket
                        </a>
                        
                        <a href="email-ticket.php?id=<?php echo $ticketId; ?>" class="block w-full bg-white hover:bg-gray-50 text-indigo-600 font-medium py-2 px-4 border border-indigo-600 rounded-md text-center transition duration-150">
