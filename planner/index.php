...
<div class="container mx-auto px-4 py-6">
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="events.php?action=create" class="bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-2 px-4 rounded">
                        ...
                        <?php foreach ($upcomingEvents as $event): ?>
                            <tr>
                                ...
                                <td class="py-4 px-4 border-b border-gray-200 text-sm">
                                    <a href="events/events.php?action=edit&id=<?php echo $event['id']; ?>" class="text-indigo-600 hover:text-indigo-900 mr-3">
                                        <i class="fas fa-edit"></i> Edit
                                    </a>
                                    <a href="tickets/tickets.php?event_id=<?php echo $event['id']; ?>" class="text-green-600 hover:text-green-900 mr-3">
                                        <i class="fas fa-ticket-alt"></i> Tickets
                                    </a>
                                    <a href="events/event-details.php?id=<?php echo $event['id']; ?>" class="text-blue-600 hover:text-blue-900">
                        ...
                        <li class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-500">
                                    <?php echo formatCurrency($activity['price']); ?> • <?php echo timeAgo($activity['created_at']); ?>
                                </p>
                            </div>
                        </li>
                        <?php endforeach; ?>
