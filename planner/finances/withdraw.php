...
<div class="container mx-auto px-4 py-6">
    ...
    <?php if ($success): ?>
        <div class="bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded mb-6">
            ...
            <p>Your withdrawal request has been submitted successfully and is pending approval. You will be notified once it's processed.</p>
        </div>
    <?php endif; ?>
                ...
                <div class="p-6">
                    <div class="mb-6 bg-blue-50 p-4 rounded-lg">
                        <p class="text-blue-800">
                            ...
                            Your available balance: <span class="font-bold"><?php echo formatCurrency($balance); ?></span>
                        </p>
                    </div>
                    ...
                    <form method="POST" action="">
                        <div class="mb-4">
                            ...
                            <div class="relative">
                                ...
                                <input type="number" id="amount" name="amount" min="1" max="<?php echo $balance; ?>" step="0.01" 
       ...
       required oninput="calculateFee(this.value)">
                        ...
                        <div class="mb-4 bg-gray-50 p-4 rounded-lg">
                            <div class="flex justify-between mb-2">
                                <span class="text-gray-600">Withdrawal Fee (<?php echo $withdrawalFeePercentage; ?>%):</span>
                        ...
                        <button type="submit" class="bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-2 px-4 rounded <?php echo (int)$balance == 0 ? 'opacity-50 cursor-not-allowed' : ''; ?>" <?php echo (int)$balance == 0 ? 'disabled' : ''; ?>>
                ...
                <div class="p-6">
                    ...
                    <?php else: ?>
                            ...
                            <?php foreach ($recentWithdrawals as $withdrawal): ?>
                                <div class="border-b pb-4 last:border-b-0 last:pb-0">
                                    <div class="flex justify-between items-start">
                                        <div>
                                            ...
                                            <p class="text-xs text-gray-500 mt-1">
                                                <?php echo formatDate($withdrawal['created_at']); ?> at <?php echo formatTime($withdrawal['created_at']); ?>
                                            </p>
                                        </div>
                                        <?php
                                        $statusClasses = [
                                    ...
                                    <p class="text-sm mt-2">
                                        <span class="text-gray-600">Method:</span> <?php echo ucfirst(str_replace('_', ' ', $withdrawal['payment_method'])); ?>
                                    </p>
                                </div>
                            <?php endforeach; ?>
                        </div>
                        ...
                        <div class="mt-4 text-center">
                            <a href="transactions.php?type=withdrawal" class="text-indigo-600 hover:text-indigo-800 text-sm">
