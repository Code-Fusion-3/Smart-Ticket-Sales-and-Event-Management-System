    ...
    <div class="bg-white rounded-lg shadow-md p-6 mb-6">
        <form method="GET" action="" class="flex flex-wrap items-end gap-4">
            <div class="w-full md:w-auto flex-grow">
                ...
                <select id="type" name="type" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:border-indigo-500">
                    ...
                    <option value="system_fee" <?php echo $type == 'system_fee' ? 'selected' : ''; ?>>System Fees</option>
