        ...
        <form method="POST" action="">
            ...
            <div class="mb-4">
                ...
                <input type="tel" id="phone" name="phone" value="<?php echo htmlspecialchars($phone); ?>"
                    class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:border-indigo-500"
                    required>
                <div id="phone-error" class="text-red-600 text-sm mt-1" style="display:none;"></div>
            </div>
                ...
                <div class="flex space-x-4">
                    <label class="inline-flex items-center">
                        <input type="radio" name="role" value="customer"
                            <?php echo $role === 'customer' ? 'checked' : ''; ?> class="mr-2">
                        <span>Customer</span>
                    </label>
                    <label class="inline-flex items-center">
                        <input type="radio" name="role" value="event_planner"
                            <?php echo $role === 'event_planner' ? 'checked' : ''; ?> class="mr-2">
