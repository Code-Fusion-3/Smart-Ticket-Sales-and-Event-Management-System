...
// Add date filter to show only future events
...
// Get events with ticket type pricing
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        ...
        <div class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition duration-300">
            <div class="relative">
                ...
                <!-- Pricing Badge -->
                <div
                    class="absolute top-0 right-0 bg-indigo-600 text-white px-3 py-1 m-2 rounded-lg text-sm font-semibold">
                    <?php 
                ...
                <?php 
                        ...
                        ?>
                <div class="absolute bottom-0 left-0 bg-red-500 text-white px-3 py-1 m-2 rounded-lg text-xs">
                    Only <?php echo $availableTickets; ?> left!
                </div>
                <?php elseif ($availableTickets <= 0): ?>
                <div class="absolute bottom-0 left-0 bg-gray-800 text-white px-3 py-1 m-2 rounded-lg text-xs">
                    Sold Out
                </div>
                <?php endif; ?>
            </div>
            ...
            <div class="p-4">
                <h3 class="text-lg font-semibold mb-2 line-clamp-2"><?php echo htmlspecialchars($event['title']); ?>
                </h3>

                <div class="flex items-center text-gray-600 mb-2 text-sm">
                    <i class="fas fa-map-marker-alt mr-2 flex-shrink-0"></i>
                    <span
                        class="truncate"><?php echo htmlspecialchars($event['venue']) . ', ' . htmlspecialchars($event['city']); ?></span>
                </div>
                ...
                <div class="mb-3 pb-3 border-b border-gray-200">
                    <div class="text-xs text-gray-500 mb-2"><?php echo $event['ticket_types_count']; ?> ticket types
                        available:</div>
                    <?php
                    ...
                    <div class="space-y-1">
                        ...
                        <div class="flex justify-between items-center text-xs">
                            <span
                                class="text-gray-700 truncate mr-2"><?php echo htmlspecialchars($type['name']); ?></span>
                            <span
                                class="text-indigo-600 font-semibold"><?php echo formatCurrency($type['price']); ?></span>
                        </div>
                        <?php endforeach; ?>
                        <?php if ($event['ticket_types_count'] > 2): ?>
                        <div class="text-xs text-gray-500">
                            +<?php echo ($event['ticket_types_count'] - 2); ?> more
                            type<?php echo ($event['ticket_types_count'] - 2) > 1 ? 's' : ''; ?>
                        </div>
                        <?php endif; ?>
                    </div>
                </div>
