            ...
            <div class="p-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    ...
                    <div>
                        ...
                        <p class="capitalize"><?php echo str_replace('_', ' ', $transaction['payment_method'] ?? 'Multiple Methods'); ?></p>
                    </div>
                    <div>
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                                    ...
                                    <tr>
                                        <td class="px-4 py-4 whitespace-nowrap">
                                            ...
                                            <div class="text-sm text-gray-500">
                                                <?php echo formatDate($ticket['start_date']); ?> at <?php echo formatTime($ticket['start_time']); ?>
                                            </div>
                                        </td>
                                        <td class="px-4 py-4 whitespace-nowrap">
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <td class="px-4 py-3 text-right font-medium"><?php echo formatCurrency($totalAmount); ?></td>
                                </tr>
                                <?php if ($serviceFee > 0): ?>
                                    <tr>
                                        <td colspan="3" class="px-4 py-3 text-right font-medium">Service Fee</td>
                                        <td class="px-4 py-3 text-right font-medium"><?php echo formatCurrency($serviceFee); ?></td>
                                    </tr>
                                <?php endif; ?>
                                <tr class="bg-gray-50">
                                    <td colspan="3" class="px-4 py-3 text-right font-bold">Total</td>
                                    <td class="px-4 py-3 text-right font-bold"><?php echo formatCurrency($totalAmount + $serviceFee); ?></td>
                                </tr>
                            </tfoot>
                        </table>
                    </div>
        ...
        <div class="bg-white rounded-lg shadow-md overflow-hidden mb-8">
            ...
            <div class="p-6">
                ...
                <?php foreach ($ticketsByEvent as $eventId => $eventData): ?>
                    <div class="mb-6 pb-6 <?php echo $eventId !== array_key_last($ticketsByEvent) ? 'border-b border-gray-200' : ''; ?>">
                        <h3 class="font-semibold text-lg mb-2"><?php echo htmlspecialchars($eventData['event_title']); ?></h3>
                        <div class="text-sm text-gray-600 mb-4">
                            <div><i class="far fa-calendar-alt mr-1"></i> <?php echo formatDate($eventData['start_date']); ?> at <?php echo formatTime($eventData['start_time']); ?></div>
                            <div><i class="fas fa-map-marker-alt mr-1"></i> <?php echo htmlspecialchars($eventData['venue']); ?>, <?php echo htmlspecialchars($eventData['city']); ?></div>
                        </div>
                                ...
                                <div class="border border-gray-200 rounded-lg overflow-hidden hover:shadow-md transition-shadow">
                                    <div class="bg-gray-50 px-4 py-3 border-b border-gray-200">
                                        <div class="flex justify-between items-center">
                                            <div class="font-medium"><?php echo htmlspecialchars($ticket['ticket_type_name'] ?? 'Standard Ticket'); ?></div>
                                    ...
                                    <div class="text-center mb-4">
                                            ...
                                            <div class="text-xs text-gray-500 mt-1">
                                                ...
                                                <p class="font-mono"><?php echo substr($ticket['qr_code'], 0, 16) . '...'; ?></p>
                                            </div>
                                        </div>

                                        
                                        <div class="text-sm">
                                            <div class="mb-1"><span class="font-medium">Recipient:</span> <?php echo htmlspecialchars($ticket['recipient_name']); ?></div>
                                            <div><span class="font-medium">Email:</span> <?php echo htmlspecialchars($ticket['recipient_email']); ?></div>
                                        </div>
                                        
                                        <div class="mt-4 flex justify-between">
                                            <a href="view-ticket.php?id=<?php echo $ticket['id']; ?>" target="_blank" class="text-indigo-600 hover:text-indigo-800 text-sm">
                                                <i class="fas fa-eye mr-1"></i> View
                                            </a>
                                            <a href="download-ticket.php?id=<?php echo $ticket['id']; ?>" class="text-indigo-600 hover:text-indigo-800 text-sm">
                ...
                <div class="mt-6 flex flex-wrap gap-4 justify-center">
                    <a href="my-tickets.php" class="bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-2 px-6 rounded transition duration-300">
                        <i class="fas fa-ticket-alt mr-2"></i> View All My Tickets
                    </a>
                    <a href="events.php" class="bg-gray-600 hover:bg-gray-700 text-white font-bold py-2 px-6 rounded transition duration-300">
                ...
                <div class="space-y-4">
                    <div class="flex items-start">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600">We've sent a confirmation email with your tickets to your registered email address. If you don't see it, please check your spam folder.</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600">Download your tickets or save them to your mobile device. You'll need to present them (either printed or on your phone) at the event entrance.</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600">Don't forget to add the event to your calendar. We'll also send you a reminder email before the event.</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600">Let your friends know you're going! Share the event on social media and invite them to join you.</p>
                        </div>
                    </div>
                </div>
            </div>
