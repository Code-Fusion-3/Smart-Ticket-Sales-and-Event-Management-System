...
function loginUser($email, $password)
{
    ...
    // Check user status and provide specific messages
    if ($user['status'] === 'suspended') {
        return ["success" => false, "message" => "Account is suspended. Please contact support for assistance."];
    }

    if ($user['status'] === 'inactive') {
        return ["success" => false, "message" => "Account is deactivated. Please contact support to reactivate your account."];
    }
