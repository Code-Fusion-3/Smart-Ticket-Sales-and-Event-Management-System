            ...
            <div class="flex flex-col md:flex-row justify-between">
                ...
                <div class="mb-6 md:mb-0">
                    ...
                    <ul class="space-y-2">
                        ...
                        <li><a href="<?php echo SITE_URL; ?>/events.php" class="text-gray-400 hover:text-white">Events</a></li>
                        <?php if (!isLoggedIn()): ?>
                            <li><a href="<?php echo SITE_URL; ?>/login.php" class="text-gray-400 hover:text-white">Login</a></li>
                            <li><a href="<?php echo SITE_URL; ?>/register.php" class="text-gray-400 hover:text-white">Register</a></li>
                        <?php endif; ?>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        <li class="flex items-center">
                            ...
                            <a href="mailto:contact@smartticket.com" class="text-gray-400 hover:text-white">contact@smartticket.com</a>
                        </li>
                        <li class="flex items-center">
