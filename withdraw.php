...
if (!isLoggedIn()) {
    redirect('login.php?redirect=withdraw.php');
    exit;
}
...
<div class="container mx-auto px-4 py-6">
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="finances.php" class="text-indigo-600 hover:text-indigo-800">
                ...
                <form method="POST" action="" class="p-6">
                    ...
                    <div class="mb-4">
                        ...
                        <select id="payment_method" name="payment_method"
                            ...
                            <option value="mobile_money" <?php if (isset($_POST['payment_method']) && $_POST['payment_method'] == 'mobile_money')
                                echo 'selected'; ?>>Mobile Money</option>
                            <option value="bank_transfer" <?php if (isset($_POST['payment_method']) && $_POST['payment_method'] == 'bank_transfer')
                    ...
                    <div class="mb-4">
                        ...
                        <textarea id="payment_details" name="payment_details" rows="3"
                            class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:border-indigo-500"
                            required><?php echo isset($_POST['payment_details']) ? htmlspecialchars($_POST['payment_details']) : ''; ?></textarea>
                        <p class="text-xs text-gray-500 mt-1">Provide your phone number for mobile money or bank account
                            details for bank transfer.</p>
                    </div>
                            ...
                            <?php foreach ($recentWithdrawals as $withdrawal): ?>
                                <div class="border-b pb-4 last:border-b-0 last:pb-0">
                                    ...
                                    <?php if (!empty($withdrawal['admin_notes'])): ?>
                                        <div class="text-xs text-blue-700 mt-2">Admin:
                                            <?php echo htmlspecialchars($withdrawal['admin_notes']); ?></div>
                                    <?php endif; ?>
                                </div>
                            <?php endforeach; ?>
                        </div>
